...
export default function Howitworks1() {
  ...
  return (
    <div className="w-[100%] flex flex-col py-5 md:flex-row-reverse justify-center items-center text-center  bg-gradient-to-r from-primary from-90% via-secondary via-30% to-bgprimary to-10%">
